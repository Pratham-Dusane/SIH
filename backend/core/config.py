...
class Settings(BaseSettings):
    ...
    # ------------------------------------------------------------------
    FEATURE_ENHANCEMENT_ENABLED: bool = os.getenv("FEATURE_ENHANCEMENT_ENABLED", "false").lower() == "true"
    FEATURE_ANNOTATION_ENABLED: bool = os.getenv("FEATURE_ANNOTATION_ENABLED", "false").lower() == "true"
    ...
    FEATURE_HISTORICAL_ENABLED: bool = os.getenv("FEATURE_HISTORICAL_ENABLED", "false").lower() == "true"
    ...
    FEATURE_LOCATION_HISTORY_ENABLED: bool = os.getenv("FEATURE_LOCATION_HISTORY_ENABLED", "false").lower() == "true"
