          ...
          <form onSubmit={handleEmailSignIn} className="space-y-3">
            <div className="space-y-1">
              ...
              <div className="relative">
                <Mail className="w-4 h-4 text-muted-foreground absolute left-3 top-3" suppressHydrationWarning />
                <input
                  type="email"
                  value={email}
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <Lock className="w-4 h-4 text-muted-foreground absolute left-3 top-3" suppressHydrationWarning />
                <input
                  type="password"
                  value={password}
