...
import { Satellite, UserPlus, Mail, Lock, AlertCircle, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md bg-card border-border shadow-xl">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-xl font-bold">Create SatQuery AI Account</CardTitle>
          <CardDescription className="text-xs">
            Join the agentic vision-language assistant for remote sensing
          </CardDescription>
        </CardHeader>
